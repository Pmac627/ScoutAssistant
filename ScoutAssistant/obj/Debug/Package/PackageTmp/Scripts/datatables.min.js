 ...
 *   https://datatables.net/download/#bs/dt-1.10.8,b-1.0.1,b-html5-1.0.1,b-print-1.0.1,r-1.0.7
 *
 * Included libraries:
 *   DataTables 1.10.8, Buttons 1.0.1, HTML5 export 1.0.1, Print view 1.0.1, Responsive 1.0.7
 */
...
sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Show _MENU_ entries",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"<b><i>Super Search:</i></b>",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:g.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
...
jQuery.fn.dataTable.ext.builder = "bs\/dt-1.10.8,b-1.0.1,b-html5-1.0.1,b-print-1.0.1,r-1.0.7";
...
(function (f, g) {
    f.extend(g.ext.buttons, {
        colvis: function (a, b) { return { extend: "collection", text: function (a) { return a.i18n("buttons.colvis", "Column visibility") }, className: "buttons-colvis", buttons: [{ extend: "columnsToggle", columns: b.columns }] } }, columnsToggle: function (a, b) { return a.columns(b.columns).indexes().map(function (a) { return { extend: "columnToggle", columns: a } }).toArray() }, columnToggle: function (a, b) { return { extend: "columnVisibility", columns: b.columns } }, columnsVisibility: function (a, b) {
            ...
            columns: null, text: function (a, b, c) { return c._columnText(a, c.columns) }, className: "buttons-columnVisibility", action: function (a, b, c, d) { a = b.column(d.columns); a.visible(void 0 !== d.visibility ? d.visibility : !a.visible()) }, init: function (a, b, c) {
                var d = this, e = a.column(c.columns); a.on("column-visibility.dt" + c.namespace, function (a, b, e, f) { e === c.columns && d.active(f) }).on("column-reorder.dt" + c.namespace, function () {
                    var e = a.column(c.columns); b.text(c._columnText(a,
                    c.columns)); d.active(e.visible())
            ...
            className: "buttons-colvisRestore", text: function (a) { return a.i18n("buttons.colvisRestore", "Restore visibility") }, init: function (a, b, c) { c._visOriginal = a.columns().indexes().map(function (b) { return a.column(b).visible() }).toArray() },
